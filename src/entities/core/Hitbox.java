...
public class Hitbox {
	...
	public boolean intersects(Hitbox rect2) {
		...
		Vector[] corners1 = getCorners(entity.xSpeed / Main.FRAMES_PER_SECOND, entity.ySpeed / Main.FRAMES_PER_SECOND);
		Vector[] corners2 = rect2.getCorners(rect2.entity.xSpeed / Main.FRAMES_PER_SECOND, rect2.entity.ySpeed / Main.FRAMES_PER_SECOND);
		
		float x1 = entity.position.x + entity.xSpeed / Main.FRAMES_PER_SECOND;
		float y1 = entity.position.y + entity.ySpeed / Main.FRAMES_PER_SECOND;
		
		float x2 = rect2.entity.position.x + rect2.entity.xSpeed / Main.FRAMES_PER_SECOND;
		float y2 = rect2.entity.position.y + rect2.entity.ySpeed / Main.FRAMES_PER_SECOND;
